...
export class MiniAppEnrollmentBridgeService {
  ...
  private resourceName = "enrollment";
  ...
  async list(params?: MiniAppApiListParam | undefined) {
    return this.bridge.callApi<Schema.Enrollment[]>(this.resourceName, "list", {
      body: params,
    });
  }

  async detail(id: string) {
    return this.bridge.callApi<Schema.Enrollment>(this.resourceName, "detail", {
      id,
    });
  }

  async autoComplete(query: string, data: any) {
    return this.bridge.callApi<Schema.EnrollmentAutoComplete[]>(
      this.resourceName,
      "autoComplete",
      {
        query,

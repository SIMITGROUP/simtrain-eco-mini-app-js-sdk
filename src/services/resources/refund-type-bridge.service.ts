...
export class MiniAppRefundTypeBridgeService {
  ...
  private resourceName = "refundType";
  ...
  async list(params?: MiniAppApiListParam | undefined) {
    return this.bridge.callApi<Schema.RefundType[]>(this.resourceName, "list", {
      body: params,
    });
  }

  async detail(id: string) {
    return this.bridge.callApi<Schema.RefundType>(this.resourceName, "detail", {
      id,
    });
  }

  async autoComplete(query: string, data: any) {
    return this.bridge.callApi<Schema.RefundTypeAutoComplete[]>(
      this.resourceName,
      "autoComplete",
      {
        query,

...
export class MiniAppCategoryBridgeService {
  private bridge: MiniAppBridgeService;

  private resourceName = "category";
  ...
  async list(params?: MiniAppApiListParam | undefined) {
    return this.bridge.callApi<Schema.Category[]>(this.resourceName, "list", {
      body: params,
    });
  }

  async detail(id: string) {
    return this.bridge.callApi<Schema.Category>(this.resourceName, "detail", {
      id,
    });
  }

  async autoComplete(query: string, data: any) {
    return this.bridge.callApi<Schema.CategoryAutoComplete[]>(
      this.resourceName,
      "autoComplete",
      {
        query,

...
| [**runCreateMany**](#runcreatemany)                             | **POST** /appintegration/bulk-create         |             |
...
> Array<AppIntegration> runCreateMany(appIntegration)
...
let appIntegration: Array<AppIntegration>; //Data

const { status, data } = await apiInstance.runCreateMany(appIntegration);
```
...
| Name               | Type                      | Description | Notes |
| ------------------ | ------------------------- | ----------- | ----- |
| **appIntegration** | **Array<AppIntegration>** | Data        |       |

...
|[**runCreateMany**](#runcreatemany) | **POST** /student/bulk-create | |
|[**runDefault**](#rundefault) | **GET** /student | |
|[**runDelete**](#rundelete) | **DELETE** /student/{id} | |
|[**runDeletePackageEnroll**](#rundeletepackageenroll) | **POST** /student-api/delete-package-enroll | |
...
|[**runSearchStudentAlphabetIndex**](#runsearchstudentalphabetindex) | **POST** /student-api/student-alphabet-index | |
|[**runSearchStudentListPaginated**](#runsearchstudentlistpaginated) | **POST** /student-api/studentlist | |
|[**runSearchStudentListWithSummary**](#runsearchstudentlistwithsummary) | **POST** /student-api/studentlist-with-summary | |
...
const { status, data } = await apiInstance.runChangePackage(
    packageChanged
);
```
...
const { status, data } = await apiInstance.runCheckForAvailablePackage(
    id
);
```
...
# **runCreateMany**
> Array<Student> runCreateMany(student)
...
let student: Array<Student>; //Data
...
# **runDeletePackageEnroll**
> string runDeletePackageEnroll(deletePackageEnrollment)
...
let deletePackageEnrollment: DeletePackageEnrollment; //Request Body

const { status, data } = await apiInstance.runDeletePackageEnroll(
    deletePackageEnrollment
);
```
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **deletePackageEnrollment** | **DeletePackageEnrollment**| Request Body | |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
|**200** | Delete student package enrollment. |  -  |
...
const { status, data } = await apiInstance.runGetActiveEnrollments(
    id
);
```
...
const { status, data } = await apiInstance.runGetEnrollmentHistories(
    id
);
```
...
const { status, data } = await apiInstance.runGetEnrollments(
    id
);
```
...
const { status, data } = await apiInstance.runGetOutstandingInvoice(
    id
);
```
...
const { status, data } = await apiInstance.runGetStudentSummary(
    id
);
```
...
const { status, data } = await apiInstance.runGetTransactions(
    id
);
```
...
const { status, data } = await apiInstance.runImportStudents(
    importStudent
);
```
...
const { status, data } = await apiInstance.runIndividualToPackage(
    individualtoPackage
);
```
...
const { status, data } = await apiInstance.runModifyPackage(
    packageModified
);
```
...
# **runSearchStudentAlphabetIndex**
> Array<StudentAlphabetIndex> runSearchStudentAlphabetIndex(body)
...
const { status, data } = await apiInstance.runSearchStudentAlphabetIndex(
    body
);
```
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
|**200** | Get student alphabet index |  -  |

[[Back to top]](#) [[Back to API list]](../README.md#documentation-for-api-endpoints) [[Back to Model list]](../README.md#documentation-for-models) [[Back to README]](../README.md)

# **runSearchStudentListPaginated**
> StudentListPaginationResponse runSearchStudentListPaginated(body)
...
const { status, data } = await apiInstance.runSearchStudentListPaginated(
    body
);
```
...
const { status, data } = await apiInstance.runSearchStudentListWithSummary(
    body
);
```

...
| [**runCreateMany**](#runcreatemany) | **POST** /miniappinstallation/bulk-create  |             |
...
> Array<MiniAppInstallation> runCreateMany(miniAppInstallation)
...
let miniAppInstallation: Array<MiniAppInstallation>; //Data

const { status, data } = await apiInstance.runCreateMany(miniAppInstallation);
```
...
| Name                    | Type                           | Description | Notes |
| ----------------------- | ------------------------------ | ----------- | ----- |
| **miniAppInstallation** | **Array<MiniAppInstallation>** | Data        |       |

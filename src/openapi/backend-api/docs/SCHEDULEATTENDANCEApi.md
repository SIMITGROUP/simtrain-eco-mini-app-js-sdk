...
| [**runCreateMany**](#runcreatemany) | **POST** /scheduleattendance/bulk-create  |             |
...
> Array<ScheduleAttendance> runCreateMany(scheduleAttendance)
...
let scheduleAttendance: Array<ScheduleAttendance>; //Data

const { status, data } = await apiInstance.runCreateMany(scheduleAttendance);
```
...
| Name                   | Type                          | Description | Notes |
| ---------------------- | ----------------------------- | ----------- | ----- |
| **scheduleAttendance** | **Array<ScheduleAttendance>** | Data        |       |

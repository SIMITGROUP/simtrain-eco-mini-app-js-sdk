...
| [**runCreateMany**](#runcreatemany) | **POST** /stopreason/bulk-create  |             |
...
> Array<StopReason> runCreateMany(stopReason)
...
let stopReason: Array<StopReason>; //Data

const { status, data } = await apiInstance.runCreateMany(stopReason);
```
...
| Name           | Type                  | Description | Notes |
| -------------- | --------------------- | ----------- | ----- |
| **stopReason** | **Array<StopReason>** | Data        |       |

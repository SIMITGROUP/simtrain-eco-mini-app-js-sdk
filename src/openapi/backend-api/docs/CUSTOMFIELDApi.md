...
| [**runCreateMany**](#runcreatemany) | **POST** /customfield/bulk-create  |             |
...
> Array<CustomField> runCreateMany(customField)
...
let customField: Array<CustomField>; //Data

const { status, data } = await apiInstance.runCreateMany(customField);
```
...
| Name            | Type                   | Description | Notes |
| --------------- | ---------------------- | ----------- | ----- |
| **customField** | **Array<CustomField>** | Data        |       |

...
| [**runCreateMany**](#runcreatemany)   | **POST** /organization/bulk-create    |             |
...
> Array<Organization> runCreateMany(organization)
...
let organization: Array<Organization>; //Data

const { status, data } = await apiInstance.runCreateMany(organization);
```

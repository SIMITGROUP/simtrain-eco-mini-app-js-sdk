...
| [**runCreateMany**](#runcreatemany)                   | **POST** /studentgroup/bulk-create     |             |
...
> Array<StudentGroup> runCreateMany(studentGroup)
...
let studentGroup: Array<StudentGroup>; //Data

const { status, data } = await apiInstance.runCreateMany(studentGroup);
```
...
| Name             | Type                    | Description | Notes |
| ---------------- | ----------------------- | ----------- | ----- |
| **studentGroup** | **Array<StudentGroup>** | Data        |       |

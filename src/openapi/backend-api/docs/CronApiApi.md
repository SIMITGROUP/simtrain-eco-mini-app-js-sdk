...
const { status, data } = await apiInstance.cronApiControllerDeleteDocumentEvents();
```
...
const { status, data } = await apiInstance.cronApiControllerMonitorStuckQueueJobs();
```
...
const { status, data } = await apiInstance.cronApiControllerSendBillingDocumentNotification();
```
...
const { status, data } = await apiInstance.cronApiControllerSendOutstandingPaymentReminders(
    studentId
);
```
...
const { status, data } = await apiInstance.cronApiControllerSendScheduleReminder();
```
...
const { status, data } = await apiInstance.cronApiControllerSendScheduledAnnouncements();
```
...
const { status, data } = await apiInstance.cronApiControllerSendTenantExpiredNotice();
```
...
const { status, data } = await apiInstance.cronApiControllerTriggerScheduleBilling();
```

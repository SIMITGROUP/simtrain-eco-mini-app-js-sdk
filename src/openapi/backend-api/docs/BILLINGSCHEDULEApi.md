...
| [**runCreateMany**](#runcreatemany) | **POST** /billingschedule/bulk-create  |             |
...
> Array<BillingSchedule> runCreateMany(billingSchedule)
...
let billingSchedule: Array<BillingSchedule>; //Data

const { status, data } = await apiInstance.runCreateMany(billingSchedule);
```
...
| Name                | Type                       | Description | Notes |
| ------------------- | -------------------------- | ----------- | ----- |
| **billingSchedule** | **Array<BillingSchedule>** | Data        |       |

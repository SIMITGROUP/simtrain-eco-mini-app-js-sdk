...
| [**runCreateMany**](#runcreatemany)         | **POST** /documentnoformat/bulk-create                 |             |
...
> Array<DocumentNoFormat> runCreateMany(documentNoFormat)
...
let documentNoFormat: Array<DocumentNoFormat>; //Data

const { status, data } = await apiInstance.runCreateMany(documentNoFormat);
```
...
| Name                 | Type                        | Description | Notes |
| -------------------- | --------------------------- | ----------- | ----- |
| **documentNoFormat** | **Array<DocumentNoFormat>** | Data        |       |

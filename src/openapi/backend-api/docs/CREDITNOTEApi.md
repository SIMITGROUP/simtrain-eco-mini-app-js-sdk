...
| [**runCreateMany**](#runcreatemany)                                               | **POST** /creditnote/bulk-create              |             |
...
> Array<CreditNote> runCreateMany(creditNote)
...
let creditNote: Array<CreditNote>; //Data

const { status, data } = await apiInstance.runCreateMany(creditNote);
```
...
| Name           | Type                  | Description | Notes |
| -------------- | --------------------- | ----------- | ----- |
| **creditNote** | **Array<CreditNote>** | Data        |       |

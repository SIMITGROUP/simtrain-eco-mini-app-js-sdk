...
| [**runCreateMany**](#runcreatemany) | **POST** /stopenrollment/bulk-create  |             |
...
> Array<StopEnrollment> runCreateMany(stopEnrollment)
...
let stopEnrollment: Array<StopEnrollment>; //Data

const { status, data } = await apiInstance.runCreateMany(stopEnrollment);
```
...
| Name               | Type                      | Description | Notes |
| ------------------ | ------------------------- | ----------- | ----- |
| **stopEnrollment** | **Array<StopEnrollment>** | Data        |       |
